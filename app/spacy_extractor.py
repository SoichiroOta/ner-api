...
class SpacyExtractor:
    ...
    def __init__(self, nlp: Language, input_id_col: str = "id", input_text_col: str = "text"):
    ...
    def extract_entities(self, records: List[Dict[str, str]]):
        ...
        for doc_id, spacy_doc in zip(ids, self.nlp.pipe(texts)):
            ...
            for ent in spacy_doc.ents:
                ...
                entities[ent_id]["matches"].append({"start": ent.start_char, "end": ent.end_char, "text": ent.text})
